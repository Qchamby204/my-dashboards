...
function mount(){
  ...
  host.innerHTML='<details'+(updates?' open':'')+'><summary>Connect projects across devices</summary><p>Use private Atlas OS for synced projects and linked commitments. This original Life Map keeps your local projects, notes, and chores.</p><a class="inline-link" href="https://atlas-os-quinton.qchambers123018.chatgpt.site/#projects" target="_blank" rel="noopener">Open synced Life Map</a><p>Export this Life Map to bring projects into Atlas OS. To return project changes here, download “Project updates” from Atlas OS, then review that file below.</p><label>Review project updates<input id="project-transfer-file" type="file" accept=".json,application/json" '+(busy?'disabled':'')+'></label>'+
