...
(() => {
  ...
  if(sharedSource&&document.head){
    ...
    if(root.dataset.atlasApp==='communication-trainer'){
      const trainer=document.createElement('script');trainer.src=new URL('communication-enhancements.js?v=topics-20260909',sharedSource).href;trainer.defer=true;document.head.appendChild(trainer);
    }
    ...
    if(root.dataset.atlasApp==='workout-forge'){
      ...
      const forge=document.createElement('script');forge.src=new URL('forge-enhancements.js?v=8782a2f13e83',sharedSource).href;forge.defer=true;document.head.appendChild(forge);
    }
